...
class ListQuestType2Adapter(val quests: ArrayList<QuestType1>) :
    RecyclerView.Adapter<ListQuestType2Adapter.ViewHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_test2, parent, false)
